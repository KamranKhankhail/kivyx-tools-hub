...
// import ColorPaletteGeneratorIcon from "@/app/_components/icons/ColorPaletteGenerator";
...
export default function page() {
  ...
  const sortedTools = [...toolsThatDoMoreToolsData].sort((a, b) => {
    if (!searchQuery) return 0; // No search query, maintain original order

    const lowerCaseSearchQuery = searchQuery.toLowerCase();

    const aMatches = a.primaryText.toLowerCase().includes(lowerCaseSearchQuery);
    const bMatches = b.primaryText.toLowerCase().includes(lowerCaseSearchQuery);
