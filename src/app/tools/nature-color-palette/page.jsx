...
// export default function NatureColorPalette() {
...
//     totalSize += 2 + 2 + gName.length * 2; // group start + name length + name
//     colors.forEach((c) => {
//       const name = new TextEncoder().encode(c + "\0");
//       totalSize += 2 + 2 + name.length * 2 + 12 + 2; // block + name len + name + RGB + type
//     });
//     totalSize += 2; // group end
...
//     // --- HEADER ---
//     view.setUint32(offset, 0x41534546); // "ASEF"
//     offset += 4;
//     view.setUint16(offset, 1); // version 1.0
//     offset += 2;
//     view.setUint16(offset, 0);
//     offset += 2;
//     view.setUint32(offset, colors.length + 1); // +1 for group end
//     offset += 4;
...
//               <Stack direction="column" key={idx} sx={{ gap: "12px", flex: 1 }}>
//                 {" "}
//                 <Box
//                   sx={{
//                     height: "60px",
