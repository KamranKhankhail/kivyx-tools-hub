...
const converters = {
  ...
  Temperature: {
    units: ["Degree Celsius (°C)", "Fahrenheit (°F)", "Kelvin (K)"],
  ...
  Area: {
    ...
    factors: {
      ...
      "Square mile (mi²)": 2589988.11, // 1 square mile = 2,589,988.11 square meters
      "Square yard (yd²)": 0.83612736, // 1 square yard = 0.83612736 square meters
    },
    type: "unit",
    keywords: [
      "square",
